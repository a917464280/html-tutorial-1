...
如需学习如何创建样式表，请访问我们的 [CSS 教程](http://www.runoob.com/css/css-tutorial.html) 。
...
如果你想学习更多关于Javascript的知识，可以访问本站的[JavaScript 教程](http://www.runoob.com/js/js-tutorial.html).
...
在您选取一家 ISP 之前，请务必阅读菜鸟教程的 [Web 主机教程。](http://www.runoob.com/hosting/hosting-tutorial.html)
